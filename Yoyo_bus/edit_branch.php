...
<?php
$query=mysqli_query($con,"select * from branch where branchid='$ID'")or die(mysqli_error());
...
mysqli_query($con," UPDATE branch SET branch_location='$branch_location' WHERE branchid = '$id' ")or die(mysqli_error());
