...
<?php
		$id=$_GET['driverid'];
		$result1 = mysqli_query($con,"SELECT * FROM driver WHERE driverid='$id'");
		while($row1 = mysqli_fetch_array($result1)){
		?>
							<tr>
								<td style="text-align:center; word-break:break-all; width:200px;"><a href="#image<?php  echo $id;?>"><?php if($row1['profile'] != ""): ?>
								<img src="slider/<?php echo $row1['profile']; ?>" width="100px" height="100px" style="border:4px groove #CCCCCC; border-radius:5px;">
								<?php else: ?>
