...
<?php
  $query=mysqli_query($con,"select * from admin LEFT JOIN branch on admin.branchid = branch.branchid where adminid='$ID'")or die(mysqli_error());
...
mysqli_query($con," UPDATE admin SET branchid='$branchid', firstname='$firstname', lastname='$lastname', username='$username', password='$password', confirm_password='$confirm_password', 
user_type='$user_type'
