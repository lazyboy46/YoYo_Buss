...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h1 style = "font-style:Calibri; margin-top:-14px; font-size:50px"></h1> Bus Dispatch and Information System</center>
				<center><h1 style = "font-style:Calibri; margin-top:-14px;"></h1> KEMPARURA</center>
				
			<p style = "margin-left:30px; margin-top:50px; font-size:14pt; font-weight:bold;">Arrived List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <div align="right">
		<b style="color:blue;">Prepared:</b>
        <?php
